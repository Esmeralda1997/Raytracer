...
LIB = -lpng
TARGET = hw4
OBJS = objs/main.o objs/image.o objs/shape.o objs/sphere.o objs/scene.o objs/triangle.o
...
objs/image.o: src/Image.cpp include/Image.h include/png.h include/pnglibconf.h include/pngconf.h
